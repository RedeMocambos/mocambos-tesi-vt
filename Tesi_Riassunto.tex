...
% Set up the document
\documentclass[a4paper, 11pt, oneside]{Tesi_Riassunto}  % Use the "Thesis" style, based on the ECS Thesis style by Steve Gunn
...
\abstract{
  ...
  Questo lavoro, basato su un'esperienza diretta, ricerca tecnologie per
  una rete federata di comunità afro-discendenti incentrata
  sull'autonomia e sulla libertà. Il lavoro propone un'architettura e
  un prototipo per una ``rete federata eventualmente connessa'' il cui
  limite e vincolo tecnologico principale è la banda e la
  disponibilità della connessione. Il prototipo è un sistema per la
  condivisione di contenuti multimediali tra portali web locali,
  basato su \emph{Django} e \emph{git-annex}, autenticati su server
  \emph{LDAP}.
