...
tecnicamente \emph{viabili} ed adattabili ad usi, costumi e contesti
...
\begin{itemize}
\item è un framework \emph{Model, View, Template}, (MVT),
...
\item consente di modellare i dati direttamente in python e l'
...
\item possiede una libreria per i \emph{forms} davvero potente ed
  ...
  ogni aspetto.
\item è un framework ``\emph{batteries included}'', ovvero
...
\item è tra i migliori framework per quanto riguarda la documentazione
  ufficiale. Oltre ad alcuni tutorial, utili per impararne le basi,
  quasi ogni aspetto del framework è documentato in modo eccellente.
\end{itemize}
