...
La Rete Mocambos (RM), attualmente, coinvolge direttamente più di 200
...
\ref{fig:MappaRedeMocambos}). Esistono due accordi\footnote{Gli
  ...
  \emph{Casa de Cultura Tainã}.} tra la Rete Mocambos i il Ministero
...
Telecentros.BR sono in corso di installazione 200 \emph{telecentros},
sale attrezzate con 10 computer ad accesso pubblico, e saranno erogate
...
potenzialità delle tecnologie digitali e stanno, a poco a poco,
cominciando a dominarle. Questo non sarebbe stato possibile senza
l'esistenza e l'ampia disponibilità di Software Libero. Tecnologie
digitali sotto forma di prodotti commerciali sarebbero un ennesimo
passo verso la dipendenza economica e culturale. Questa consapevolezza
è alla base di scelte ben ponderate. Ricordo che, qualche anno fa a
Brasilia, ad una riunione del programma del governo federale \emph{Luz
  para Todos}, programma per fornire elettricità anche alla
popolazione in zone rurali e amene, un \emph{cacique}\footnote{
  \emph{Cacique} è un termine con cui si definiscono i capi di alcune
  comunità indigene in America latina. } fece presente che pur volendo
...
condizione. Avere un contatore e una bolletta per ogni casa
significherebbe introdurre costi in denaro, che non sono compatibili
con la loro cultura e nemmeno con la loro economia.
