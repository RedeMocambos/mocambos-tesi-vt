...
Um agradecimento especial para as minhas famílias\ldots
...
%% ----------------------------------------------------------------
\lhead{\emph{Conte\'udos}}  % Set the left side page header to "Contents"
...
\lhead{\emph{Siglas}}  % Set the left side page header to "Abbreviations"
...
\input{./Capitoli/Capitolo3} % Introdução 

\input{./Capitoli/Capitolo4} % Architettura

\input{./Capitoli/Capitolo5} % Prototipo
...
\input{./Appendici/AppendiceA}	% Appendice codice sorgente
