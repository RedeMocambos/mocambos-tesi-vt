...
This work research on technologies for a federated network of
afrodescendats communities looking at autonomy and freedom. The work
propose an architecture and prototype for an eventually connected
federated network where the main limit and technical bond is connection
availability and bandwidth. The prototype is a media sharing system
for local portals, based on Django and Git-Annex, authenticated on LDAP
servers.
...
\input{./Capitoli/Capitolo1} % Introduction

\input{./Capitoli/Capitolo2} % Background Theory 

\input{./Capitoli/Capitolo3} % Experimntal Setup
...
%\input{./Appendici/AppendiceA}	% Appendix Title
